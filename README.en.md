...
> The committed screenshot is a 2×2 contact sheet of **real body pages** —
> not the front matter — produced against the Zhengzhou University
> undergraduate thesis template (V2): **table of contents, a figure/table
> sample page, a math equation sample page, and the references section**.
> These pages exercise what the skill actually rebuilds: three-level TOC
> with page-number leaders, centered+bold figure/table captions, three-line
> tables, numbered display equations, and the bibliography style. The
